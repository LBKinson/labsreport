...
# this year visits, uniques, pageviews, ppvs, bounce, visit duration
    ...
    @tyPhotoViews = photoViewsGalleries['ga:pageviews'].to_f + photoViewsArtists['ga:pageviews'].to_f
...
def mcmonthly
    ...
    @tyPhotoViews2 = photoViewsGalleries2['ga:pageviews'].to_f + photoViewsArtists2['ga:pageviews'].to_f
